# Generated by Django 2.0.5 on 2019-05-27 03:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ST', 'Student'), ('TU', 'Tutor')], default='TU', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_app.HomeworkDetail')),
            ],
        ),
        migrations.CreateModel(
            name='Module',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('teacher', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='CustomUser', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='ModuleTitle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_app.Module'),
        ),
    ]
